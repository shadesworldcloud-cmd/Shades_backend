...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `automatic_offer_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `automatic_offer_categories` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `automatic_offer_products`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `automatic_offer_products` (
  `AUTOMATIC_OFFER_ID` bigint NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `automatic_offers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `automatic_offers` (
...
-- Shades World / Claude-copy canonical MySQL 8 schema
-- Reconstructed on 2026-08-08 from the base DDL plus every migration in the copy.
-- Run after creating/selecting the target database, for example:
--   CREATE DATABASE ECOMMERCE_DB CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
--   USE ECOMMERCE_DB;
-- WARNING: this rebuild script drops existing tables in the selected database.
